  ...
  return (
    <div className='flex items-center justify-between border-b-2 fixed top-0 left-0 right-0 z-20 bg-white'>
        ...
        <div className='flex items-center justify-center relative ml-1 pt-1 hover:text-gray-800'>
            ...
            <Link href="/" ><h2 className='text-2xl text-black-600 font-bold tracking-tighter'>Akatsuki</h2></Link>
        ...
        <div className='flex items-center justify-between'>
            ...
            <div className='mr-5 md:mr-7 ' data-tip='Your account'><Avatar name='Aman' size={35} round={true}/></div>
        </div>
